...
\begin{figure}[h!]
    ...
    \hfill
     ...
     \begin{subfigure}[b]{0.49\textwidth}
         \centering
         \includegraphics[width=\textwidth]{graph/histo_beta_lo50000_500_4e-05.png}
         \subcaption{$N=50,000$}
     \end{subfigure}
    \hfill
     \begin{subfigure}[b]{0.49\textwidth}
         \centering
         \includegraphics[width=\textwidth]{graph/histo_beta_hi50000_500_4e-05.png}
         \subcaption{$N=50,000$}
     \end{subfigure}     
   
\floatfoot{\footnotesize

\textbf{Notes}: This figure compares simulation results for the main specificaiton, a fixed target parameter $LATE(0.35, 0.9)$ and different sample sizes $N$.
The solid line indicates the true upper bound, the true lower bound is given by -0.138. The dashed line correspond to the mean of the estimator. Additionally, the plot shows a normal distrbution with the mean and variance equal to the moments of the estimator distributions.}
